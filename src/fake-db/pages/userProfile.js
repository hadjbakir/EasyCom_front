    ...
    connections:[
      {
        ...
        reviewCount: 124,
        chips: [
          { title: "design", color: "primary" },
          { title: "UI/UX", color: "info" },
        ],
        startingPrice: 75,
        available: true,
        featured: true,
      },
      {
        ...
        reviewCount: 98,
        chips: [
          { title: "video", color: "secondary" },
          { title: "animation", color: "success" },
        ],
        startingPrice: 60,
        available: true,
        featured: false,
      },
      {
        ...
        reviewCount: 76,
        chips: [
          { title: "copywriting", color: "warning" },
          { title: "content", color: "info" },
        ],
        startingPrice: 45,
        available: false,
        featured: false,
