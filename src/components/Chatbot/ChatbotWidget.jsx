...
const chatGradient =
  "linear-gradient(135deg, #d86db0 0%, #b35bb5 25%, #8156b7 50%, #824396 75%, #392760 100%)"
...
const StyledFab = styled(Fab, {
  ...
  background: isOpen
    ? '#8e839b'
    : "linear-gradient(135deg, #bb4edc 0%, #d86db0 100%)",
  color: theme.palette.getContrastText('#8156b7'),
  '&:hover': {
    background: isOpen
      ? '#623e91'
      : "linear-gradient(135deg, #d86db0 0%, #b35bb5 100%)",
          ...
          <ChatHeader>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <Avatar sx={{ width: 32, height: 32, bgcolor: '#fff' }}>
                <img src="/images/chatbot/chatbot.png" alt="Chatbot" style={{ width: 28, height: 28, objectFit: 'contain' }} />
              </Avatar>
              <Box>
                    ...
                    >
                      {!message.isUser && (
                        <Avatar sx={{ width: 24, height: 24, bgcolor: '#fff' }}>
                          <img src="/images/chatbot/chatbot.png" alt="Chatbot" style={{ width: 20, height: 20, objectFit: 'contain' }} />
                        </Avatar>
                      )}
