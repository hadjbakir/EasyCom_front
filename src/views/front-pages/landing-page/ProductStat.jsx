...
const statData = [
  {
    ...
    value: '1,200+',
    svg: <Check color='var(--mui-palette-primary-main)' />,
  ...
  },
  {
    ...
    value: '50,000+',
    svg: <LaptopCharging color='var(--mui-palette-success-main)' />,
    color: 'var(--mui-palette-success-darkerOpacity)',
    isHover: false
  },
  {
    title: 'Creative Services Booked',
    value: '3,500+',
    svg: <User color='var(--mui-palette-info-main)' />,
    color: 'var(--mui-palette-info-darkerOpacity)',
    isHover: false
  },
  {
    title: 'AI Searches Performed',
    value: '8,000+',
    svg: <Diamond color='var(--mui-palette-warning-main)' />,
