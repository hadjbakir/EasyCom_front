...
import Reviews from '@/app/[lang]/(dashboard)/(private)/apps/explore/stores/[id]/Reviews'
import apiClient from '@/libs/api'

const StoreDetailsContent = ({ id, user }) => {
  const storeId = id
          ...
          <NegotiationProvider>
            <OrderProvider>
              <ServiceOrderProvider>
                <StoreDetailsContent id={id} user={user} />
              </ServiceOrderProvider>
            </OrderProvider>
          </NegotiationProvider>
        </CartProvider>
