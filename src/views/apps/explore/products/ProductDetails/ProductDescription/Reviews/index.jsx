...
import { Card, Box, Typography, Stack, LinearProgress, Rating, Avatar, Button, Collapse, CircularProgress, Alert } from "@mui/material"
...
const Reviews = ({ productId, supplierId }) => {
  ...
  const handleSubmitReview = async (reviewData) => {
    try {
      ...
      if (isSupplier) {
        setSubmitError('Suppliers cannot review their own products')
        return
      }
      ...
      const newReview = {
        ...response.data.data,
        user: session.user // Add user info from session
      }
